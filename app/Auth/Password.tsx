        ...
        >
            <View style={{ paddingTop: top, alignItems: 'center' }}>
                ...
                <View style={styles.inputContainer}>
                    <TextInput
                        placeholder="* * * * * * * *"
                        style={{ width: '80%', height: '100%', fontSize: 18, fontWeight: 'bold', marginLeft: 10, color: '#00414C', fontFamily: 'Nunito' }}
                    ...
                    />
                    <TouchableOpacity activeOpacity={.7} onPress={() => setPasswordVisible(!passwordVisible)} style={styles.eyeIcon}>
            ...
            <View style={styles.inner}>
                <View style={{ paddingTop: top, alignItems: 'center' }}>
                    ...
                    <View style={styles.infoContainer}>
                        <TextS style={styles.title}>Parolni kiriting</TextS>
                        <TextS style={styles.subtitle}>
                            Tasdiqlash kodini olish uchun quyidagi maydonga parolingizni kiriting.
                        </TextS>
                    </View>
                ...
                <TouchableOpacity activeOpacity={0.8} style={[styles.button, {marginBottom: 20}]} onPress={EnterPasswordFunc}>
                    {loading ? (
                        <ActivityIndicator size="small" color="#002930" />
                    ) : (
                        <TextS style={styles.buttonText}>Davom etish</TextS>
